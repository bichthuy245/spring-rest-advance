package com.nashtech.training.filter;
...
@Component
public class ShapeCorsFilter extends OncePerRequestFilter {

        private static final Logger LOG = LoggerFactory.getLogger(ShapeCorsFilter.class);
